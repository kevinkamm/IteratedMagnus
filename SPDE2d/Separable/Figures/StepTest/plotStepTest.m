...
excludeMethods={'EulerRef','Magnus3'};
...
M=curr.Result.Magnus2.M;
dtLog=curr.Result.Magnus2.dtLog;
d=curr.Result.Magnus2.d;
T=curr.Result.Magnus2.T;

[stepDtSorted,I]=sort(stepDt(:,2),1);
...
if isfield(curr.Result,'Magnus3')
